...
/**
 * @author haohao on 2017/8/1 13:47
 * @version v1.0
 */
public class Lunar {
    ...
    public String toString() {
        return year + "年" + (leap ? "闰" : "") + chineseNumber[month - 1] + "月" + getChinaDayString(
                day);
    }

    public String monthAndDaytoString() {
    ...
    public void setCurrentTimeLunarMonth(Calendar cal) {
        @SuppressWarnings("unused") int yearCyl, monCyl, dayCyl;
        int leapMonth = 0;
        Date baseDate = null;
        try {
    ...
    public static Calendar getCalendar(CalendarDate date) {
